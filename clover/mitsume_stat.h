...
//#define MITSUME_STAT_ENABLE 
        ...
        #define MITSUME_STAT_ADD(type,num)\
                mitsume_stat_add(type, num)
        #define MITSUME_STAT_SUB(type,num)\
                mitsume_stat_sub(type, num)
        #define MITSUME_STAT_SET(type,num)\
                mitsume_stat_set(type, num)
        #define MITSUME_STAT_ARRAY_ADD(index,num)\
                mitsume_stat_array_add(index, num)
        #define MITSUME_STAT_ARRAY_SUB(index,num)\
                mitsume_stat_array_sub(index, num)
        #define MITSUME_STAT_SUM(index, num)\
                mitsume_stat_sum(index, num)
#else
        ...
        #define MITSUME_STAT_SUM(index, num)
#endif
#define MITSUME_STAT_FORCE_ADD(type,num)\
        mitsume_stat_add(type, num)
#define MITSUME_STAT_FORCE_SUB(type,num)\
        mitsume_stat_sub(type, num)
...
#define MITSUME_STAT_GET_TIME_END(a)    mitsume_stat_get_time_end(a, __LINE__, __FILE__, thread_metadata->thread_id)
#define MITSUME_STAT_GET_TIME_END_NULLID(a)    mitsume_stat_get_time_end(a, __LINE__, __FILE__, 0) 
...
//        "[clt] # of xact-commit doesn't match",
        ...
        "[clt] # of write-address userspace memcpy",
        "[clt] # of pointer chasing",
        "[clt] # of shortcut chasing",
        "[clt] # of chasing backup",
        "[clt] # of queried entries",
        "[clt] # of asked entries",
        "[clt] # of received entries",
        "[clt] # of retry asked entries times",
        "[clt] # of sent GC requests",
        "[clt] # of removed shortcut updates",
        "[clt] # of outdated query",
        "[clt] # of mismatch crc check",
        "=================================",
        "[con] # of asked entries",
        "[con] # of distributed entries",
        "[con] # of queried entries",
        "[con] # of open entries",
        "[con] # of backup-open entries",
        "[con] # of received GC requests",
        "[con] # of processed GC entries",
        "[con] # of recycled GC entries",
        "[con] # of epoched-unprocessed GC entries",
        "[con] # of epoched GC entries",
        "[con] # of send backup update request",
        "[con] # of received backup update request",
        "[con] # of max GC version",
        "[con] # of management request",
        "[con] # of stat update",
        "=================================",
        "[IB] write",
        "[IB] read",
