...
int main(int argc, char *argv[])
{
	...
	//assert(sizeof(struct mica_op) *	NUM_CLIENTS * NUM_WORKERS * WINDOW_SIZE < RR_SIZE);
	...
	int num_clients=MITSUME_CLT_NUM, num_servers=MITSUME_CON_NUM, num_memorys=MITSUME_MEM_NUM;
	int device_id = 0;
	int num_loopback = -1;
	...
	static struct option opts[] = {
		...
		{"num-clients",	1, NULL, 'c'},
		{"num-servers",	1, NULL, 's' },
		{"num-memorys",	1, NULL, 'm' },
		{"is-client", 1, NULL, 'C' },
		{"is-server", 1, NULL, 'S' },
		{"is-memory", 1, NULL, 'M' },
		{"machine-id", 1, NULL, 'I' },
		{"device-id", 1, NULL, 'd' },
		{"num-loopbackset",	1, NULL, 'L' },
		{NULL, 0, NULL, 0}
	};
    ...
    MITSUME_PRINT("size of %d %d\n", (int) sizeof(struct mitsume_msg), (int) sizeof(struct mitsume_large_msg));
