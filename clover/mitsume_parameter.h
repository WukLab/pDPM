...
#include <cstdint>
#define MITSUME_MR_PERMISSION (IBV_ACCESS_LOCAL_WRITE|IBV_ACCESS_REMOTE_WRITE|IBV_ACCESS_REMOTE_READ|IBV_ACCESS_REMOTE_ATOMIC)
...
//#define MITSUME_GET_PTR_OFFSET(A)               ((A&MITSUME_PTR_MASK_OFFSET)>>27)<<7 //it should be 27 bit. However, the granularity is 128B which is 7 B -->27-7 = 20
#define MITSUME_GET_PTR_NEXT_VERSION(A)         (A&MITSUME_PTR_MASK_NEXT_VERSION)>>19
#define MITSUME_GET_PTR_ENTRY_VERSION(A)        (A&MITSUME_PTR_MASK_ENTRY_VERSION)>>11
...
//#define MITSUME_SET_PTR_OFFSET(A)             ((((uint64_t)A) << 20) & MITSUME_PTR_MASK_OFFSET)
//#define MITSUME_SET_PTR_OFFSET(A)               ((((uint64_t)A>>7)<<27)& MITSUME_PTR_MASK_OFFSET)
#define MITSUME_SET_PTR_NEXT_VERSION(A)         ((((uint64_t)A) << 19)  & MITSUME_PTR_MASK_NEXT_VERSION)
#define MITSUME_SET_PTR_ENTRY_VERSION(A)        ((((uint64_t)A) << 11)  & MITSUME_PTR_MASK_ENTRY_VERSION)
#define MITSUME_SET_PTR_XACT_AREA(A)            ((((uint64_t)A) << 1) & MITSUME_PTR_MASK_XACT_AREA)
...
#define MITSUME_TOOL_QUERY_HASHTABLE_SIZE_BIT MITSUME_CON_NAMER_HASHTABLE_SIZE_BIT
...
#define MITSUME_CLT_NUM 4
#define MITSUME_MEM_NUM 4
...
#define MITSUME_MEMORY_LH_CUT_MIN_UNIT (MITSUME_CON_ALLOCATOR_SLAB_SIZE_GRANULARITY)
...
#define MITSUME_LRU_PER_QUEUE_SIZE (MITSUME_LRU_SIZE/(1<<MITSUME_LRU_BUCKET_BIT))
