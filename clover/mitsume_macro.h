...
#define RSEC_WHOLE_DEBUG
        ...
        //        printf("[R_SECURITY] %s:%d :\t" inputstring, __func__, __LINE__, ##args)
        //        printf("[R_SECURITY] %s:%d :\t" inputstring, __func__, __LINE__, ##args)
        ...
        #define MITSUME_PRINT_BRIEF(string, args...) \
                printf("[BRIEF] " string, ##args)
        ...
        #define RSEC_ERROR(string, args...) \
                printf("[R_SECURITY-ERROR] " string, ##args)
        #define MITSUME_INFO(inputstring, args...) \
                printf("[INFO] " inputstring, ##args)
#endif
...
const static char MITSUME_MEMCACHED_MEMORY_ALLOCATION_STRING[] = "memory-alloc-%d";
